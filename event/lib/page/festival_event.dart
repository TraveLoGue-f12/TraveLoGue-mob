...
class FestivalEventHomePage extends StatefulWidget {
  static const ROUTE_NAME = "/festival-event";
  const FestivalEventHomePage({super.key});

  @override
  State<FestivalEventHomePage> createState() => _FestivalEventHomePageState();
}

class _FestivalEventHomePageState extends State<FestivalEventHomePage> {
