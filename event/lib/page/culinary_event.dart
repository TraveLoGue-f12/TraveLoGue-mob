...
class CulinaryEventHomePage extends StatefulWidget {
  static const ROUTE_NAME = "/culinary-event";
  const CulinaryEventHomePage({super.key});

  @override
  State<CulinaryEventHomePage> createState() => _CulinaryEventHomePageState();
}

class _CulinaryEventHomePageState extends State<CulinaryEventHomePage> {
